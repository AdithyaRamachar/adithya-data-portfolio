...
const projects = [
  ...
  },
  {
    ...
    url: "https://github.com/AdithyaRamachar/Credit-Card_Fraud-detection",
    problem: "Massive class imbalance made it hard to detect rare fraudulent transactions.",
    approach: "SMOTE oversampling + ensemble methods (Random Forest, XGBoost) with precision-recall optimization.",
    tools: ["Python", "XGBoost", "Scikit-learn", "SMOTE"],
    impact: "Achieved high recall on fraud cases while maintaining acceptable precision for production use.",
    next: "Deploy as real-time scoring service with transaction velocity features.",
  },
  {
